...
{
    public class Getterek : Creature
    {
        public Getterek(Texture2D sprite, Texture2D overlay, Texture2D negate,
        ...
        {
            return "Getterek Creature - UnderWorld Taskmaster Courage: 50 Power: 95 Wisdom: 25 Speed: 45 Energy: 60 " +
            ...
            "It is recommended that you pay the toll before you cross the bridge.";
        }
    }
}
