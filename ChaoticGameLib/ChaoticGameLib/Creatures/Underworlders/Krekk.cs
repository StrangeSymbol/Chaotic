...
namespace ChaoticGameLib.Creatures
{
    ...
    {
        public Krekk(Texture2D sprite, Texture2D overlay, Texture2D negate, 
            byte energy, byte courage, byte power, byte wisdom, byte speed) :
            base(sprite, overlay, negate, energy, courage, power, wisdom, speed, 0, true, false, false, false, 0,
            true, 0, 0, false, false, false, 0, 0, 0, 0, 0, 10, 0, 0, Tribe.UnderWorld, CreatureType.CommanderScout)
        {
        }
