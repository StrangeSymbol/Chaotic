...
{
    public class Ektospasm : Attack
    {
        public Ektospasm(Texture2D sprite, Texture2D overlay, Texture2D negate)
        ...
        {
            return base.Description() + "Stat Check Power 50: Deal 5 damage.";
        }
    }
}
