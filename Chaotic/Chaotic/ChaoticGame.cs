...
namespace Chaotic
{
    enum ChaoticGameStage
    {
        Shuffles, BeginningOfTheGame, CoinFlip, LocationStep, Moving, ReturnLocation,
        ...
        HiveCallDecision, TargetAttack, ReturnLocationMugic,
    };

    /// <summary>
    /// This is a game component that implements IUpdateable.
    /// </summary>
    public class ChaoticGame : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public ChaoticGame(Game game, GraphicsDeviceManager graphics, CreatureNumber creatureNumber)
            : base(game)
        {
        ...
        private void setAbilityPath(bool isPlayer1, AbilityType abilityType, AbilityAction action)
        {
            ...
            switch (abilityType)
            {
                ...
                case AbilityType.ChangeLocation:
                    stageQueue.Enqueue(GameStage.ReturnLocation); // Not working.
                    turnOffLocation(); // Removes location effects.
                    break;
                default:
                    break;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < creatureSpaces.Length; i++)
            {
                ...
                if (!discardPile1.DiscardPanelActive && !attackDiscardPile1.DiscardPanelActive
                    ...
                    creatureSpaces[i].UpdateCardDescription(mouse); // TODO: Make new function that doesn't show p2 battlegear.
            ...
            ChaoticEngine.BurstContents.UpdateBox(gameTime); // TODO: Change so that only shows up when P1 needs to do something.
            ...
            switch (ChaoticEngine.GStage)
            {
                ...
                case GameStage.CoinFlip:
                    bool? flip = coin.UpdateCoin(gameTime, Keyboard.GetState()); // TODO: Maybe something where AI flips.
                ...
                case GameStage.ShowdownCoinFlip:
                    flip = coin.UpdateCoin(gameTime, Keyboard.GetState()); // TODO: Maybe something where AI flips.
